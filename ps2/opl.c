...
// PS2: the only OPL driver is our software renderer (opl_ps2.c).
extern opl_driver_t opl_ps2_driver;
...
// Advance the software OPL clock synchronously (chip detection relies on this:
// it starts a timer, OPL_Delay()s, then expects the timer to have expired).
void OPL_Delay(uint64_t us)
{
    extern void OPL_PS2_AdvanceUs(uint64_t us);
